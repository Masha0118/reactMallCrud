...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
    ...
    @Query("select " +
            " new orz.zerock.mallapi.dto.CartItemListDTO(ci.cino, ci.qty, p.pno, p.pname, p.price, pi.fileName)" +
            "from " +
    ...
    @Query("select new orz.zerock.mallapi.dto.CartItemListDTO(ci.cino, ci.qty, p.pno, p.pname, p.price, pi.fileName)" +
            "from " +
            "CartItem ci inner join ci.cart mc " +
